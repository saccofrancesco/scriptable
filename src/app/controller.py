...
class WorkshiftController(QObject):
    ...
    def add_employee(
        ...
        first_name, last_name, monthly_target_hours = validate_employee_fields(
            first_name, last_name, monthly_target_hours, lunch_break_hours
        )
    ...
    def edit_shift(
        ...
        shift: Shift = require_shift(self.schedule, shift_id)
